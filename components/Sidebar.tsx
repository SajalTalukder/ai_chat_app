...
const Sidebar = () => {
  return (
    <div className="flex flex-col w-64 fixed top-0 left-0 h-screen bg-[#0b1733] border-r border-white/10 text-white">
      ...
      <div className="flex-1 overflow-y-auto">
        <h1 className="px-4 mt-4 text-gray-400 text-sm font-semibold cursor-pointer">
          Recent History
        </h1>
